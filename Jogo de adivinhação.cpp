...
{
    int Ne, Na, T, rep, Qp, Qg=0, C, Cont=0, DivM=1, opc, x, y, res; //Variaveis escolhidas. Qg recebe 0 no inicio do programa para que, caso o usuario perca, ele mostre 0 no final do programa. Cont e 0 pois ele precisa somar o numero de tentativas ate acertar. DivM recebe 1 pois, caso o usuario nao ganhe nenhuma partida, nao corre o risco do programa quebrar pois ele representa o divisor no calculo da media
    float Med; //Med vai ser uma variavel float por serresponsavel por calcular uma media
    ...
    if(rep == 0){ //Adicao do if-else para verificar se o usuario deseja jogar novamente ou nao. Alem de aparecer uma mensagem caso o usuario coloque um valor invalido para a variavel rep
        ...
        printf("[4] - Divisao\n");
        printf("Escolha qual voce deseja fazer -> ");
        scanf("%d", &opc);
        ...
        case 1:
            ...
            printf("A resposta da soma entre %d e %d e %d", x, y, res);
        ...
        case 2:
            ...
            printf("A resposta da subtracao entre %d e %d e %d", x, y, res);
        ...
        case 3: 
            ...
            printf("\nA resposta da multiplicacao entre %d e %d e %d\n", x, y, res);
        ...
        case 4:
            ...
            printf("\nA resposta da divisao entre %d e %d e %d\n", x, y, res);
